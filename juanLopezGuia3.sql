...
insert into clientes(cli_nombre, cli_Apellido, cli_dni, cli_tel)values("Matias","Karlen", "12.124.543","11-3453-5645");

insert into empleados(emp_nombre, emp_Apellido, emp_dni, emp_tel,emp_sueldo,emp_fechaIn,rol_id)values("Juan","López", "44.403.375","15-5666-7040",80000,"2020-11-15",2);